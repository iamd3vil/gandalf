// Code generated by gandalf(BuildDate: 2026-07-26 13:17:47, Version: 873f523 (2026-07-26 12:17:17 +0530)). DO NOT EDIT.
package main
...
func (s *TestStruct) Validate() error {
	...
	if len(s.Name) > 5 {
		return errors.New("name can't be greater than 5")
	}
	if s.Age == 0 {
	...
	if s.Age > 30 {
		return errors.New("age can't be greater than 30")
	}
	if s.Height == 0 {
	...
	if s.Height > 10.5 {
		return errors.New("height can't be greater than 10.5")
	}
	if s.List == nil {
	...
	if len(s.List) > 5 {
		return errors.New("list can't be greater than 5")
	}
	return nil
}
